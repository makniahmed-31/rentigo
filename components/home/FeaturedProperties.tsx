          ...
          {loading ? (
            <div className="flex gap-5 overflow-hidden">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="min-w-[260px] flex-1 aspect-[4/3] bg-gray-100 rounded-2xl animate-pulse"
                />
              ))}
            </div>
          ) : properties.length === 0 ? (
            ...
            >
              {properties.map((p) => (
                <div
                  key={p._id}
                  className="min-w-[260px] max-w-[260px] flex-shrink-0 sm:min-w-[280px] sm:max-w-[280px]"
                >
