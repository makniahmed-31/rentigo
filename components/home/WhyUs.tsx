"use client"
import { Shield, Calendar, MessageCircle, CreditCard, Headphones } from "lucide-react"
...
export default function WhyUs() {
  ...
  const features = [
    ...
    { icon: MessageCircle, title: t.features.whatsapp, desc: t.features.whatsappDesc },
    { icon: CreditCard, title: t.features.payment, desc: t.features.paymentDesc },
